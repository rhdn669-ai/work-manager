...
import { subscribeDmRooms, getDmRoomId, hideDmRoomForUser } from '../services/chatService';
    ...
    <div className="channel-list-page">
      <div className="channel-list-header">
        ...
        <div className="channel-list-actions">
          ...
          <button className="channel-action-btn" onClick={() => setShowNewDm(true)} title="새 1:1 대화 시작">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="16" height="16">
      ...
      <div className="channel-list">
        ...
        <div className="channel-section-label" style={{ marginTop: 8 }}>
          1:1 대화
        </div>
        {dmRooms.length === 0 && (
