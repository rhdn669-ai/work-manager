          ...
          <div className="card-body">
            <div className="balance-overview" style={{ display: 'flex', flexWrap: 'wrap', gap: 4 }}>
              <div className="balance-item" style={{ flex: '1 1 50px', minWidth: 50 }}>
                <div className="balance-label" style={{ fontSize: 11 }}>누적 발생</div>
                <div className="balance-value" style={{ fontSize: 18 }}>{balance.totalDays}일</div>
              </div>
              <div className="balance-item" style={{ flex: '1 1 50px', minWidth: 50 }}>
                <div className="balance-label" style={{ fontSize: 11 }}>사용</div>
                <div className="balance-value used" style={{ fontSize: 18 }}>{balance.usedDays}일</div>
              </div>
              <div className="balance-item" style={{ flex: '1 1 50px', minWidth: 50 }}>
                <div className="balance-label" style={{ fontSize: 11 }}>잔여</div>
                <div className="balance-value remaining" style={{ fontSize: 18 }}>{balance.remainingDays}일</div>
              </div>
            </div>
