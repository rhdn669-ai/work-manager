  ...
  return (
    <aside className={`sidebar ${isOpen ? 'open' : ''}`}>
      <nav className="sidebar-nav">
        ...
        {canApproveLeave && !isAdmin && <NavLink to="/manage/leave" end className="nav-link">연차 신청 현황</NavLink>}
        {isAdmin && <NavLink to="/admin/reports" className="nav-link">직원 잔업·연차</NavLink>}
