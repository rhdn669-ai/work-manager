...
import * as fbMail from './firebase';
import * as server from './serverData';
import * as serverMail from './serverMail';
...
// 메일 보내기도 같은 스위치를 탄다 — 서버 모드면 NAS 의 메일 살림, 아니면 구글 함수.
export const callSendEmail = isServer ? serverMail.callSendEmail : fbMail.callSendEmail;
